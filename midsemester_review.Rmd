...
```{r}
img <- readPNG("resources/midsemester_review/1_intro_image.png")
grid.raster(img)
```
...
```{r}
grid.raster(readPNG("resources/midsemester_review/3_gg.png"))
```
...
```{r}
img <- readPNG("resources/midsemester_review/box1.png")
grid.raster(img)
```
...
```{r}
img <- readPNG("resources/midsemester_review/ridge.png")
grid.raster(img)
```
...
```{r}
img <- readPNG("resources/midsemester_review/mosaic1.png")
grid.raster(img)
```
...
```{r}
img <- readPNG("resources/midsemester_review/mosaic2.png")
grid.raster(img)
```

```{r}
img2 <- readPNG("resources/midsemester_review/mosaic3.png")
grid.raster(img2)
```
...
```{r}
img <- readPNG("resources/midsemester_review/heatmaps.png")
grid.raster(img)
```
...
```{r}
img <- readPNG("resources/midsemester_review/timeseries.png")
grid.raster(img)
```
...
```{r}
img2 <- readPNG("resources/midsemester_review/timeseries2.png")
grid.raster(img2)
```
