...
knitr::include_graphics("Inspect.jpg")
```
...
```{r, out.width = "500px",echo=FALSE}
knitr::include_graphics("html structure.jpg")
```
...
```{r, out.width = "500px",echo=FALSE}
knitr::include_graphics("example read link.jpg")
```
...
```{r, out.width = "500px",echo=FALSE}
knitr::include_graphics("example locate table.jpg")
```
