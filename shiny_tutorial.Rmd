# Creating Interactive Data Vis Using Shiny
Duanyue Yun (UNI: dy2400), Boyu Liu (UNI: bl2791)
...
```
  ...
  `dataTableOutput()`, `htmlOutput()`, `imageOutput()`, `plotOutput()`, `tableOutput()`, `textOutput()`,
