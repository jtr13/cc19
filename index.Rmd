...
3. The first line should be a single hashtag (\#) followed by your project name (this does not have to be exact same as the project folder name and may include white space). Do not use single \# headers anywhere else in the document.
