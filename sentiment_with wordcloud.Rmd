---
title : Visualizing Movie Reviews in Word Cloud
output: html_document
author: Samrat Halder and Hariz Johnson
---
...
reviews <- read.csv("reviews.csv", row.names = NULL)
dataset <- reviews$x
...
pal <- pal[-(1:2)]
png("wordcloud.png", width=1280,height=900)
